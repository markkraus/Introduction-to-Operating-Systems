...
int  main(int argc, char *argv[])
{
  ...
  11:	6a 01                	push   $0x1
  13:	e8 ab 03 00 00       	call   3c3 <getcount>
  ...
  23:	e8 58 04 00 00       	call   480 <printf>
    if (fork() == 0) {
  28:	e8 ee 02 00 00       	call   31b <fork>
  2d:	83 c4 10             	add    $0x10,%esp
  30:	85 c0                	test   %eax,%eax
  32:	75 58                	jne    8c <main+0x8c>
        printf(1, "child fork count %d\n", getcount(SYS_fork));
  34:	83 ec 0c             	sub    $0xc,%esp
  37:	6a 01                	push   $0x1
  39:	e8 85 03 00 00       	call   3c3 <getcount>
  3e:	83 c4 0c             	add    $0xc,%esp
  41:	50                   	push   %eax
  42:	68 bf 07 00 00       	push   $0x7bf
  47:	6a 01                	push   $0x1
  49:	e8 32 04 00 00       	call   480 <printf>
        printf(1, "child write count %d\n", getcount(SYS_write));
  4e:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  55:	e8 69 03 00 00       	call   3c3 <getcount>
  5a:	83 c4 0c             	add    $0xc,%esp
  5d:	50                   	push   %eax
  5e:	68 d4 07 00 00       	push   $0x7d4
  63:	6a 01                	push   $0x1
  65:	e8 16 04 00 00       	call   480 <printf>
  ...
  70:	6a 03                	push   $0x3
  72:	e8 4c 03 00 00       	call   3c3 <getcount>
  77:	83 c4 0c             	add    $0xc,%esp
  7a:	50                   	push   %eax
  7b:	68 17 08 00 00       	push   $0x817
  80:	6a 01                	push   $0x1
  ...
  94:	6a 01                	push   $0x1
  96:	e8 28 03 00 00       	call   3c3 <getcount>
  9b:	83 c4 0c             	add    $0xc,%esp
  9e:	50                   	push   %eax
  9f:	68 ea 07 00 00       	push   $0x7ea
  a4:	6a 01                	push   $0x1
  a6:	e8 d5 03 00 00       	call   480 <printf>
        printf(1, "parent write count %d\n", getcount(SYS_write));
  ab:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  b2:	e8 0c 03 00 00       	call   3c3 <getcount>
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 26 08 00 00       	mov    $0x826,%edx
        while(*s != 0){
 ...
 621:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 30 0b 00 00    	mov    %edx,0xb30
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 30 0b 00 00    	mov    %edx,0xb30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 30 0b 00 00    	mov    0xb30,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 34 0b 00 00       	mov    $0xb34,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 792:	00 00 00 
    if(p->s.size >= nunits){
