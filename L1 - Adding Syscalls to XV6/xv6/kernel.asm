...
80102088:	68 42 79 10 80       	push   $0x80107942
...
801024d2:	81 fb d0 6a 11 80    	cmp    $0x80116ad0,%ebx
...
80103077:	68 d0 6a 11 80       	push   $0x80116ad0
...
801037cf:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037d0:	81 c3 d4 00 00 00    	add    $0xd4,%ebx
...
80103827:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 bf 58 10 80 	movl   $0x801058bf,0x14(%eax)
  p->context = (struct context*)sp;
...
801038e6:	68 40 77 10 80       	push   $0x80107740
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 54 52 11 80       	mov    %eax,0x80115254
  if((p->pgdir = setupkvm()) == 0)
801039c3:	e8 e8 34 00 00       	call   80106eb0 <setupkvm>
...
801039e1:	e8 7a 31 00 00       	call   80106b60 <inituvm>
...
80103a4f:	68 70 77 10 80       	push   $0x80107770
80103a54:	50                   	push   %eax
80103a55:	e8 f6 0d 00 00       	call   80104850 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 79 77 10 80 	movl   $0x80107779,(%esp)
...
80103a93:	68 57 77 10 80       	push   $0x80107757
...
80103acb:	e8 80 2f 00 00       	call   80106a50 <switchuvm>
  return 0;
...
80103b48:	0f 84 d7 00 00 00    	je     80103c25 <fork+0x105>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103b4e:	83 ec 08             	sub    $0x8,%esp
80103b51:	ff 33                	push   (%ebx)
80103b53:	89 c7                	mov    %eax,%edi
80103b55:	ff 73 04             	push   0x4(%ebx)
80103b58:	e8 43 34 00 00       	call   80106fa0 <copyuvm>
80103b5d:	83 c4 10             	add    $0x10,%esp
80103b60:	89 47 04             	mov    %eax,0x4(%edi)
80103b63:	85 c0                	test   %eax,%eax
80103b65:	0f 84 c1 00 00 00    	je     80103c2c <fork+0x10c>
  np->sz = curproc->sz;
80103b6b:	8b 03                	mov    (%ebx),%eax
80103b6d:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  *np->tf = *curproc->tf;
80103b70:	b9 13 00 00 00       	mov    $0x13,%ecx
  np->sz = curproc->sz;
80103b75:	89 07                	mov    %eax,(%edi)
  np->parent = curproc;
80103b77:	89 f8                	mov    %edi,%eax
80103b79:	89 5f 14             	mov    %ebx,0x14(%edi)
  *np->tf = *curproc->tf;
80103b7c:	8b 7f 18             	mov    0x18(%edi),%edi
80103b7f:	8b 73 18             	mov    0x18(%ebx),%esi
80103b82:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for (int i = 0; i < 22; i++) {
80103b84:	89 c7                	mov    %eax,%edi
80103b86:	8d 40 7c             	lea    0x7c(%eax),%eax
80103b89:	8d 97 d4 00 00 00    	lea    0xd4(%edi),%edx
80103b8f:	90                   	nop
    np->sys_count[i] = 0;
80103b90:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for (int i = 0; i < 22; i++) {
80103b96:	83 c0 04             	add    $0x4,%eax
80103b99:	39 c2                	cmp    %eax,%edx
80103b9b:	75 f3                	jne    80103b90 <fork+0x70>
  np->tf->eax = 0;
80103b9d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(i = 0; i < NOFILE; i++)
80103ba0:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103ba2:	8b 40 18             	mov    0x18(%eax),%eax
...
80103bb6:	74 13                	je     80103bcb <fork+0xab>
...
80103bc7:	89 44 b1 28          	mov    %eax,0x28(%ecx,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103bcb:	83 c6 01             	add    $0x1,%esi
80103bce:	83 fe 10             	cmp    $0x10,%esi
80103bd1:	75 dd                	jne    80103bb0 <fork+0x90>
...
80103c2a:	eb ef                	jmp    80103c1b <fork+0xfb>
    kfree(np->kstack);
...
80103c50:	eb c9                	jmp    80103c1b <fork+0xfb>
...
80103cb0:	e8 9b 2d 00 00       	call   80106a50 <switchuvm>
...
80103cc2:	e8 e4 0b 00 00       	call   801048ab <swtch>
      switchkvm();
80103cc7:	e8 74 2d 00 00       	call   80106a40 <switchkvm>
      c->proc = 0;
...
80103e40:	05 d4 00 00 00       	add    $0xd4,%eax
...
80103e57:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e5e:	05 d4 00 00 00       	add    $0xd4,%eax
...
80103e80:	81 c2 d4 00 00 00    	add    $0xd4,%edx
...
80103ea7:	90                   	nop
80103ea8:	05 d4 00 00 00       	add    $0xd4,%eax
...
80103ed7:	68 c8 77 10 80       	push   $0x801077c8
80103edc:	e8 9f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ee1:	83 ec 0c             	sub    $0xc,%esp
80103ee4:	68 bb 77 10 80       	push   $0x801077bb
...
80103f27:	90                   	nop
80103f28:	81 c3 d4 00 00 00    	add    $0xd4,%ebx
...
80103f3f:	74 5f                	je     80103fa0 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f41:	81 c3 d4 00 00 00    	add    $0xd4,%ebx
      havekids = 1;
...
80103fb9:	e8 72 2e 00 00       	call   80106e30 <freevm>
        p->pid = 0;
...
80104150:	05 d4 00 00 00       	add    $0xd4,%eax
...
80104167:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010416e:	05 d4 00 00 00       	add    $0xd4,%eax
...
801041b0:	05 d4 00 00 00       	add    $0xd4,%eax
...
8010422b:	68 5b 7b 10 80       	push   $0x80107b5b
80104230:	e8 6b c4 ff ff       	call   801006a0 <cprintf>
80104235:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104238:	81 c3 d4 00 00 00    	add    $0xd4,%ebx
...
8010424f:	74 e7                	je     80104238 <procdump+0x28>
      state = "???";
80104251:	ba eb 77 10 80       	mov    $0x801077eb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104256:	83 f8 05             	cmp    $0x5,%eax
80104259:	77 11                	ja     8010426c <procdump+0x5c>
8010425b:	8b 14 85 4c 78 10 80 	mov    -0x7fef87b4(,%eax,4),%edx
      state = "???";
80104262:	b8 eb 77 10 80       	mov    $0x801077eb,%eax
...
80104271:	68 ef 77 10 80       	push   $0x801077ef
...
80104ab5:	74 19                	je     80104ad0 <syscall+0x40>
    curproc->sys_count[num - 1] += 1;
80104ab7:	83 44 83 78 01       	addl   $0x1,0x78(%ebx,%eax,4)
    curproc->tf->eax = syscalls[num]();
80104abc:	ff d2                	call   *%edx
80104abe:	89 c2                	mov    %eax,%edx
80104ac0:	8b 43 18             	mov    0x18(%ebx),%eax
80104ac3:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104c34:	68 38 79 10 80       	push   $0x80107938
...
80104c4c:	68 37 79 10 80       	push   $0x80107937
...
80104c61:	68 2b 79 10 80       	push   $0x8010792b
...
80104c7f:	68 3a 79 10 80       	push   $0x8010793a
80104c84:	e8 f7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c89:	83 ec 0c             	sub    $0xc,%esp
80104c8c:	68 1c 79 10 80       	push   $0x8010791c
...
8010508d:	58                   	pop    %eax
8010508e:	5a                   	pop    %edx
8010508f:	68 38 79 10 80       	push   $0x80107938
...
801050a8:	68 37 79 10 80       	push   $0x80107937
...
801057b0:	68 80 52 11 80       	push   $0x80115280
801057b5:	e8 16 ee ff ff       	call   801045d0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ba:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057bd:	8b 1d 60 52 11 80    	mov    0x80115260,%ebx
  while(ticks - ticks0 < n){
...
801057d3:	68 80 52 11 80       	push   $0x80115280
801057d8:	68 60 52 11 80       	push   $0x80115260
801057dd:	e8 8e e8 ff ff       	call   80104070 <sleep>
  while(ticks - ticks0 < n){
801057e2:	a1 60 52 11 80       	mov    0x80115260,%eax
...
80105800:	68 80 52 11 80       	push   $0x80115280
...
80105823:	68 80 52 11 80       	push   $0x80115280
...
80105844:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105847:	68 80 52 11 80       	push   $0x80115280
8010584c:	e8 7f ed ff ff       	call   801045d0 <acquire>
  xticks = ticks;
80105851:	8b 1d 60 52 11 80    	mov    0x80115260,%ebx
  release(&tickslock);
80105857:	c7 04 24 80 52 11 80 	movl   $0x80115280,(%esp)
...
// return how many times the syscall has been referenced
int
sys_getcount(void)
{
...
80105873:	83 ec 20             	sub    $0x20,%esp
  ...
  // Retrieve syscall number from user space
  if (argint(0, &n) < 0) {
80105876:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105879:	50                   	push   %eax
8010587a:	6a 00                	push   $0x0
8010587c:	e8 cf f0 ff ff       	call   80104950 <argint>
80105881:	83 c4 10             	add    $0x10,%esp
80105884:	85 c0                	test   %eax,%eax
80105886:	78 18                	js     801058a0 <sys_getcount+0x30>
    // Invalid Syscall ID
    return -1;
  }

  return myproc()->sys_count[n - 1];
80105888:	e8 f3 e0 ff ff       	call   80103980 <myproc>
8010588d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105890:	8b 44 90 78          	mov    0x78(%eax,%edx,4),%eax
80105894:	c9                   	leave  
80105895:	c3                   	ret    
...
801058e7:	c7 04 c5 c2 52 11 80 	movl   $0x8e000008,-0x7feead3e(,%eax,8)
801058ee:	08 00 00 8e 
801058f2:	66 89 14 c5 c0 52 11 	mov    %dx,-0x7feead40(,%eax,8)
801058f9:	80 
801058fa:	c1 ea 10             	shr    $0x10,%edx
801058fd:	66 89 14 c5 c6 52 11 	mov    %dx,-0x7feead3a(,%eax,8)
80105904:	80 
  for(i = 0; i < 256; i++)
...
80105917:	c7 05 c2 54 11 80 08 	movl   $0xef000008,0x801154c2
8010591e:	00 00 ef 
  initlock(&tickslock, "time");
80105921:	68 7d 79 10 80       	push   $0x8010797d
80105926:	68 80 52 11 80       	push   $0x80115280
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010592b:	66 a3 c0 54 11 80    	mov    %ax,0x801154c0
80105931:	c1 e8 10             	shr    $0x10,%eax
80105934:	66 a3 c6 54 11 80    	mov    %ax,0x801154c6
  initlock(&tickslock, "time");
...
8010595b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010595f:	b8 c0 52 11 80       	mov    $0x801152c0,%eax
...
801059a4:	ff 24 85 24 7a 10 80 	jmp    *-0x7fef85dc(,%eax,4)
...
801059c3:	e8 b8 df ff ff       	call   80103980 <myproc>
...
801059e0:	e8 9b df ff ff       	call   80103980 <myproc>
...
801059f2:	0f 84 b8 00 00 00    	je     80105ab0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801059f8:	e8 83 df ff ff       	call   80103980 <myproc>
...
80105a50:	e8 0b df ff ff       	call   80103960 <cpuid>
...
80105a85:	68 e0 79 10 80       	push   $0x801079e0
80105a8a:	e8 11 ac ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105a8f:	83 c4 20             	add    $0x20,%esp
80105a92:	e8 e9 de ff ff       	call   80103980 <myproc>
80105a97:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a9e:	e8 dd de ff ff       	call   80103980 <myproc>
...
80105ab4:	0f 85 3e ff ff ff    	jne    801059f8 <trap+0x78>
    yield();
80105aba:	e8 61 e5 ff ff       	call   80104020 <yield>
...
80105acf:	e8 8c de ff ff       	call   80103960 <cpuid>
80105ad4:	57                   	push   %edi
80105ad5:	56                   	push   %esi
80105ad6:	50                   	push   %eax
80105ad7:	68 88 79 10 80       	push   $0x80107988
...
80105b15:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b18:	e8 73 ef ff ff       	call   80104a90 <syscall>
    if(myproc()->killed)
...
80105b33:	5d                   	pop    %ebp
      exit();
80105b34:	e9 87 e2 ff ff       	jmp    80103dc0 <exit>
...
80105b65:	e8 a6 cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b6a:	e8 11 de ff ff       	call   80103980 <myproc>
...
80105b90:	68 80 52 11 80       	push   $0x80115280
80105b95:	e8 36 ea ff ff       	call   801045d0 <acquire>
      wakeup(&ticks);
80105b9a:	c7 04 24 60 52 11 80 	movl   $0x80115260,(%esp)
      ticks++;
80105ba1:	83 05 60 52 11 80 01 	addl   $0x1,0x80115260
      wakeup(&ticks);
80105ba8:	e8 83 e5 ff ff       	call   80104130 <wakeup>
      release(&tickslock);
80105bad:	c7 04 24 80 52 11 80 	movl   $0x80115280,(%esp)
80105bb4:	e8 b7 e9 ff ff       	call   80104570 <release>
...
{
  if(!uart)
80105c10:	a1 c0 5a 11 80       	mov    0x80115ac0,%eax
...
80105c97:	74 78                	je     80105d11 <uartinit+0xd1>
  uart = 1;
80105c99:	c7 05 c0 5a 11 80 01 	movl   $0x1,0x80115ac0
80105ca0:	00 00 00 
...
80105cac:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105caf:	bf a4 7a 10 80       	mov    $0x80107aa4,%edi
...
80105cc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105cd0:	a1 c0 5a 11 80       	mov    0x80115ac0,%eax
...
80105d20 <uartputc>:
  if(!uart)
80105d20:	a1 c0 5a 11 80       	mov    0x80115ac0,%eax
...
80106955:	e8 36 dd ff ff       	call   80104690 <memset>
...
8010699d:	68 ac 7a 10 80       	push   $0x80107aac
...
801069b3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069b6:	e8 a5 cf ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106a40:	a1 c4 5a 11 80       	mov    0x80115ac4,%eax
...
80106a74:	0f 84 c2 00 00 00    	je     80106b3c <switchuvm+0xec>
  pushcli();
80106a7a:	e8 01 da ff ff       	call   80104480 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a7f:	e8 7c ce ff ff       	call   80103900 <mycpu>
80106a84:	89 c3                	mov    %eax,%ebx
80106a86:	e8 75 ce ff ff       	call   80103900 <mycpu>
...
80106a98:	e8 63 ce ff ff       	call   80103900 <mycpu>
...
80106ae1:	e8 1a ce ff ff       	call   80103900 <mycpu>
...
80106b04:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b07:	e8 f4 cd ff ff       	call   80103900 <mycpu>
...
80106b8f:	e8 fc da ff ff       	call   80104690 <memset>
...
80106bc2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bc3:	e9 68 db ff ff       	jmp    80104730 <memmove>
    panic("inituvm: more than a page");
80106bc8:	83 ec 0c             	sub    $0xc,%esp
80106bcb:	68 f1 7a 10 80       	push   $0x80107af1
...
80106c30:	68 0b 7b 10 80       	push   $0x80107b0b
...
80106cb8:	68 ac 7b 10 80       	push   $0x80107bac
...
80106d1b:	e8 70 d9 ff ff       	call   80104690 <memset>
...
80106d59:	68 29 7b 10 80       	push   $0x80107b29
...
80106dbb:	68 41 7b 10 80       	push   $0x80107b41
...
80106ed0:	e8 bb d7 ff ff       	call   80104690 <memset>
...
80106f3b:	a3 c4 5a 11 80       	mov    %eax,0x80115ac4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107170:	e8 bb d5 ff ff       	call   80104730 <memmove>
    len -= n;
    buf += n;
